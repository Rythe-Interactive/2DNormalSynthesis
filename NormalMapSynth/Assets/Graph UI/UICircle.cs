...
public class UICircle : Graphic
{
    ...
    public void Init(Color c, float radius,float xCoord, float yCoord)
    {
        this.rectTransform.localPosition = new Vector3(xCoord, yCoord);
        this.rectTransform.sizeDelta = new Vector2(25 * radius, 25 * radius);
